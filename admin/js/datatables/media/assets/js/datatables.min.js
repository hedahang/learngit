...
$.extend($.fn.dataTableExt.oPagination, {
    bs_normal: {
        ...
        fnUpdate: function(t, e) {
            ...
            for (h.iTotalPages < l ? (o = 1, s = h.iTotalPages) : h.iPage <= u ? (o = 1, s = l) : h.iPage >= h.iTotalPages - u ? (o = h.iTotalPages - l + 1, s = h.iTotalPages) : (o = h.iPage - u + 1, s = o + l - 1), i = 0, n = c.length; n > i; i++) {
                for ($("li:gt(0)", c[i]).filter(":not(:last)").remove(), r = o; s >= r; r++) a = r == h.iPage + 1 ? 'class="active"': "",
                $("<li " + a + '><a href="#">' + r + "</a></li>").insertBefore($("li:last", c[i])[0]).bind("click",
                function(i) {
                    i.preventDefault(),
    ...
    bs_two_button: {
        ...
        fnUpdate: function(t) {
            if (t.aanFeatures.p) {
                ...
                t.oClasses;
                for (var i = t.aanFeatures.p,
                n = 0,
                r = i.length; r > n; n++) 0 === e.iPage ? $("li:first", i[n]).addClass("disabled") : $("li:first", i[n]).removeClass("disabled"),
    ...
    bs_four_button: {
        ...
        fnUpdate: function(t) {
            if (t.aanFeatures.p) {
                ...
                for (var i = t.aanFeatures.p,
                n = 0,
                r = i.length; r > n; n++) 0 === e.iPage ? ($("li:eq(0)", i[n]).addClass("disabled"), $("li:eq(1)", i[n]).addClass("disabled")) : ($("li:eq(0)", i[n]).removeClass("disabled"), $("li:eq(1)", i[n]).removeClass("disabled")),
    ...
    bs_full: {
        ...
        fnUpdate: function(t, e) {
            if (t.aanFeatures.p) {
                var i, n, r, a, o = t.oInstance.fnPagingInfo(),
